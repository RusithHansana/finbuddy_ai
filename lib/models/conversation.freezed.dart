...
mixin _$Conversation {
  ...
  int get hashCode => Object.hash(runtimeType, id, userId, title, createdAt,
      updatedAt, lastMessageText, messageCount);
...
extension ConversationPatterns on Conversation {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, String userId, String title, DateTime createdAt,
            DateTime updatedAt, String? lastMessageText, int? messageCount)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _Conversation() when $default != null:
        return $default(_that.id, _that.userId, _that.title, _that.createdAt,
            _that.updatedAt, _that.lastMessageText, _that.messageCount);
      case _:
        return orElse();
    }
  }
